  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-1 flex-col overflow-hidden relative z-10">
        <header className="flex h-16 shrink-0 items-center gap-x-4 border-b border-border/50 bg-background/50 backdrop-blur-md px-4 md:px-6 justify-between">
          <div className="flex items-center gap-2">
            <MobileSidebar />
            <div className="flex-1 font-bold text-lg tracking-tight md:hidden">AI-POS</div>
          </div>
